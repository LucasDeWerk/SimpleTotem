<template>
  <div class="admin-panel">
    ...
    <main class="panel-content">
      ...
      <!-- Seção: Cancelamento -->
      <section v-show="activeSection === 'cancelamento'" class="content-section">
        <div class="section-card">
          <div class="card-header">
            <div>
              <h3 class="card-title">Cancelamento de Transação</h3>
              <p class="card-description">
                Estorno de pagamentos aprovados via SiTef
              </p>
            </div>
          </div>
...
import CancelamentoPanel from '@/components/admin/CancelamentoPanel.vue'
...
const ADMIN_SECTIONS = new Set(['peripherals', 'cancelamento', 'config'])
